                    ...
                    <table class="table table-hover">
                        ...
                        <tr class="first">
                            ...
                            <a href="<?php echo yii\helpers\Url::to(['product/mod', 'productid' => $product->productid]); ?>">编辑</a>
                                <a href="<?php echo yii\helpers\Url::to(['product/onoroff', 'productid' => $product->productid]); ?>"><?php echo ($product->ison) ? '下架' : '上架' ?></a>
<!--                            <a href="--><?php //echo yii\helpers\Url::to(['product/onoroff', 'productid' => $product->productid]); ?><!--">下架</a>-->
