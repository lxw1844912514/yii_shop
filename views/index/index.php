            ...
            <div class="col-xs-12 col-md-5 no-margin">
                <div class="product-item-holder size-big single-product-gallery small-gallery">
                    ...
                    <div class="gallery-thumbs clearfix">
                        <ul>
                            <li><a class="horizontal-thumb active" data-target="#best-seller-single-product-slider" data-slide="0" href="#slide1"><img alt="<?php echo $last->title ?>" src="<?php echo $last->cover ?>-covermiddle" data-echo="<?php echo $last->cover ?>-covermiddle" /></a></li>
                            <?php foreach ((array)json_decode($last->pics, true) as $key => $pic): ?>
                                <li><a class="horizontal-thumb" data-target="#best-seller-single-product-slider" data-slide="<?php echo (int)$key+1; ?>" href="#slide<?php echo (int)$key+2; ?>"><img alt="" src="<?php echo $pic ?>-covermiddle" data-echo="<?php echo $pic ?>-covermiddle" /></a></li>
                            <?php endforeach; ?>
                        </ul>
                    </div><!-- /.gallery-thumbs -->
